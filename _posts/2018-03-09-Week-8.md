...
![Run 1](https://raw.githubusercontent.com/copperstick6/copperstick6.github.io/master/images/run.jpg){:height="600px" width="400px"}

Second mile was less good.... It was OK.  

![Run 2](https://raw.githubusercontent.com/copperstick6/copperstick6.github.io/master/images/run2.jpg){:height="600px" width="400px"}
...
Oh and I just spend an extra like hour after I posted this blog messing with some css to resize the image. So **DING DING DING** Bonus Tip! In order to embed an image via Jekyll use the following syntax: `![image hover text](link)` and then to format it, add this right after it.`{:height="600px" width="400px"}`. It uses CSS, so you can also add in other tags if you'd like.
